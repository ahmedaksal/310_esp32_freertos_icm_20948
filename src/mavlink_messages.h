...
void send_mavlink_msg_rc_channels(uint16_t elapsed_us)
{
    ...
    rc_channels.chan1_raw = elapsed_us;
    rc_channels.chan2_raw = 30;
    rc_channels.chan3_raw = 40;
    rc_channels.chan4_raw = 50;
...
void send_mavlink_SCALED_IMU(uint32_t time_boot_ms,
                             ...
                             int16_t xmag, int16_t ymag, int16_t zmag)
{
    ...
    scaled_imu.yacc = yacc; /*< [mG] Y acceleration*/
    scaled_imu.zacc = zacc; /*< [mG] Z acceleration*/

    scaled_imu.xgyro = xgyro; /*< [mrad/s] Angular speed around X axis*/
    scaled_imu.ygyro = ygyro; /*< [mrad/s] Angular speed around Y axis*/
